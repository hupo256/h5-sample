...
import addressData from '@src/common/utils/city.json'
import ua from '@src/common/utils/ua'
import fun from '@src/common/utils'
const { fixScroll, formatAddres } = fun
const { isIos } = ua
let addersList = []
          ...
          <li className="border flex">
            ...
            <div className="item">
              <input
                ...
                onChange={(e) => {
                  onChange(e.target.value, 'mobile')
                }}
              />
            </div>
          </li>
          ...
          <li className="border flex textarea">
            ...
            <div className="item">
              <textarea
                ...
                onChange={(e) => {
                  onChange(e.target.value, 'addressDetail')
                }}
              />
            </div>
          </li>
