...
class PartCard extends Component {
    static propTypes = {
      ...
      downReportBtn=() => {
        if (UA.isAndall()) {
          andall.invoke('openUrl', { url:'https://images.dnatime.com/boss/report/enjoy_yourself.pdf' })
        } else {
          window.location.href = 'https://images.dnatime.com/boss/report/enjoy_yourself.pdf'
        }
      }
      // 确认报告信息
