    ...
    fun(params).then(({ code }) => {
      if (!code) {
        if (weight) {
          ...
          this.props.history.push(`/height-index?linkmanId=${linkManId}&brithday=${birthday}&measureDate=${fmtDate(date)}`)
        }
      }
    })
  }
    ...
    return (
      <Page title='记录身高数据'>
        <div className={styles.infoCont} style={{
          background: `url(${images.addBg}) no-repeat rgba(246,246,240,1)`,
          backgroundSize: '100%'
        }}>
          <div className={styles.data} onClick={this.handleEditDate}>
            {fmtDate(date, '/')}
            <img className={styles.edit} src={images.edit} alt='' />
          </div>
            ...
            <div className={styles.heightDetailCont}>
              ...
              <div id='babyHeight' className={styles.babyHeight}>
                ...
                <span className={styles.triangleLeft}>
                  <img src={images.triangleLeft} alt='' />
                </span>
          ...
          <div className={styles.weightCont}>
            ...
            <span className={styles.triangleDown}>
              <img src={images.triangleDown} alt='' />
            </span>
