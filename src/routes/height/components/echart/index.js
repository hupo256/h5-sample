...
class EchartsCom extends React.Component {
  ...
  handleSetImage = (value) => {
    if (value === 1) {
      return 'image://https://images.dnatime.com/app/source/picture/5f322bee-edfe-42af-856a-7c6d4300d6c9.PNG'
    } else if (value === 2) {
      return 'image://https://images.dnatime.com/app/source/picture/de1629fb-ec56-40e7-86cf-2500aa15fd25.PNG'
    } else if (value === 3) {
      return 'image://https://images.dnatime.com/app/source/picture/0703933b-1297-471e-af0e-4cdac2aa13ac.PNG'
    } else if (value === 4) {
      return 'image://https://images.dnatime.com/app/source/picture/e025d192-5719-4749-a8cf-dd2abb8269ae.PNG'
    } else if (value === 5) {
      return 'image://https://images.dnatime.com/app/source/picture/5c069bff-dbcf-4700-9015-7e4219ac5d23.PNG'
    }
  }
  // 制作折线图
