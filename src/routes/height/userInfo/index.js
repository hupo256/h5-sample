...
class UserInfo extends React.Component {
  ...
  handleNext = () => {
    ...
    this.props.history.push(`/add-record?linkManId=${linkManId}&birthday=${birth}&sex=${sex}&linkManName=${encodeURIComponent(linkManName)}`)
  }
  handleBlur = () => {
      ...
      <Page title='确认宝宝信息'>
        <div className={styles.infoCont}
          ...
          <div className={styles.photo}>
            <img src={sex === 'male' ? images.infoMale : images.infoFemale} alt='' />
          </div>
          ...
          <div className={styles.birthCont} onClick={this.handleEditDate}>
            ...
            <img className={styles.down} src={images.down} alt='' />
          </div>
