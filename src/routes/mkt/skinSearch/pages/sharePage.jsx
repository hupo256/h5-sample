...
const { yinyang, bindOnly } = images
const { getParams } = fun
class Share extends React.Component {
    state = {
      thisMatch:getParams().thisMatch,
      shareUrl:`${window.location.origin}/andall-sample/skinSearch/homePage?viewType=link`,
      share:false,
      shareText:'',
    ...
    if (isAndall) {
      setTimeout(() => {
        andall.invoke('share', {
          ...
          title: '我的专属护肤品匹配神器',
          text: shareText,
          thumbImage: `${bindOnly}fangtu.png`,
          image: `${bindOnly}fangtu.png`,
        })
      }, 200)
    } else {
                ...
                </p>
                {
                  thisMatch === 'null'
                    ...
                    : <div>
                      ...
                      <img src={`${yinyang}manicon${localStorage.headImgType}.png`} className={styles.left} />
                      {
                        +type === 1
