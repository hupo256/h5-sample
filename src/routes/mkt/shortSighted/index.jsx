...
import styles from './shortSighted'
...
class Xinguan extends React.Component {
  ...
  render () {
    ...
    return (
      <Page title='儿童视力保护大作战'>
        <div className={styles.xinguan}>
          <div className={styles.imgbox}>
            <span className={styles.toShare} onClick={() => this.toShare()} />
            <img src={images.shortSighted1} alt='' />
            <img src={images.shortSighted2} alt='' />
            <img src={images.shortSighted3} alt='' />
            <img src={images.shortSighted4} alt='' />
            <img src={images.shortSighted5} alt='' />
            <img src={images.shortSighted6} alt='' />
            <img src={images.shortSighted7} alt='' />
          </div>
