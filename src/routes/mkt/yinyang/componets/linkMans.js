...
class LinkMans extends React.Component {
  ...
  touchZhanJia = () => {
    const bannerURL = origin.indexOf('//test') > 0 ? 
      'https://test02wechatshop.dnatime.com/andall-sample/article-detail-index?id=2782779195370496&type=1' : 
      'https://wechatshop.dnatime.com/andall-sample/article-detail-index?id=2832785031916544&type=1'
    YYGJZJbannergoto()
