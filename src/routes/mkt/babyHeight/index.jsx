...
class SkinCare extends React.Component {
  ...
  render () {
    ...
    return (
      <Page title='让孩子超越父母，从身高开始'>
        <div className={styles.xinguan}>
          <div className={styles.imgbox}>
            <span className={styles.toShare} onClick={() => this.toShare()} />
            <img src={images.babyHeight1} alt='' />
            <img src={images.babyHeight2} alt='' />
            <img src={images.babyHeight3} alt='' />
            <img src={images.babyHeight4} alt='' />
            <img src={images.babyHeight5} alt='' />
            <img src={images.babyHeight6} alt='' />
            <img src={images.babyHeight7} alt='' />
            <img src={images.babyHeight8} alt='' />
            <img src={images.babyHeight9} alt='' />
            <img src={images.babyHeight10} alt='' />
            <img src={images.babyHeight11} alt='' />
            <img src={images.babyHeight12} alt='' />
            <img src={images.babyHeight13} alt='' />
            <img src={images.babyHeight14} alt='' />
          </div>
