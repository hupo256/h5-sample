...
let sensorsServerUrl = (IS_ENV === 'production' || IS_ENV === 'pre')
  ? 'https://scdata.dnatime.com/sa?project=production' // 生产production
  : 'https://scdata.dnatime.com/sa?project=default' // 测试 default
sensors.init({
  // show_log: true,
  show_log: false,
