...
const samplingCreate = () => {
  ...
  // HPV采集器样本状态列表
  sampling.listHPVReportStatusInfoByBarCode = params => (
    ajaxinstance.get('collector/listHPVReportStatusInfoByBarCode', { params })
  )

  // HPV采集器样本状态列表
  sampling.getCollectorHjAddress = params => (
    ajaxinstance.get('collector/getCollectorHjAddress', { params })
  )
